...
#define MAX_STORES \
    7  // = 6 different stores... since the 1st one (0) is the standard one..
// client data that stays across deathmatch respawns
typedef struct {
    client_persistant_t
        coop_respawn;  // what to set client->pers to on a respawn
...
struct gclient_s {
    ...
    float
        flood_other_locktill;  // locked from spamming throwup and addball etc.
