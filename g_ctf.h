...
// #define STAT_						24 //used in
// STAT_HUD_STRING1
#define STAT_JUMP_KEY_ATTACK 25
// #define STAT_						26 //used in
// STAT_HUD_STRING2
...
typedef enum { CTF_NOTEAM, CTF_TEAM1, CTF_TEAM2 } ctfteam_t;
...
#define CTF_FRAG_CARRIER_BONUS \
    2                            // what you get for fragging enemy flag carrier
...
#define CTF_CARRIER_PROTECT_BONUS \
    1  // bonus for fraggin someone while either you or your target are near
       // your flag carrier
...
#define CTF_TARGET_PROTECT_RADIUS \
    400  // the radius around an object being defended where a target will be
         // worth extra frags
#define CTF_ATTACKER_PROTECT_RADIUS \
    400  // the radius around an object being defended where an attacker will
...
#define CTF_AUTO_FLAG_RETURN_TIMEOUT \
    30  // number of seconds before dropped flag auto-returns
